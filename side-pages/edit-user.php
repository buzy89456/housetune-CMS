    ...
    <main class="main-content">
        ...
        <div class="container">
            ...
            <?php else : ?>
                ...
                <form action="doUpdateUser.php?id=<?= $row["id"] ?>" method="post">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="valid" id="">
                                    <option value="1" <?php if ($row["valid"] == 1) {
                                                            echo "selected";
                                                        } ?>>使用中</option>
                                    <option value="0" <?php if ($row["valid"] == 0) {
                                                            echo "selected";
                                                        } ?>>已停權</option>
                                </select>
                            </td>
                ...
                <div class="d-flex justify-content-center mt-3">
                    <a href="user-detail.php?id=<?= $row["id"] ?>" class="btn btn-primary">返回會員詳細資料</a>
                </div>
            <?php endif; ?>
        </div>
    </main>

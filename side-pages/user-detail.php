        ...
        <div class="container">
            ...
            <table class="table table-bordered mt-3">
                ...
                <tr>
                    <th>異動</th>
                    <td>
                        <a href="edit-user.php?id=<?= $row["id"] ?>" class="btn btn-info me-4">編輯資訊</a>
                        <button type="button" class="btn btn-danger text-light" data-bs-toggle="modal" data-bs-target="#deleteModal">永久刪除使用者</button>
                    </td>
                </tr>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a href="delete-user.php?id=<?= $row["id"] ?>" class="btn btn-danger text-light">刪除</a>
            ...
            <div class="d-flex justify-content-evenly">
                <a href="user-list.php" class="btn btn-primary mt-2">回會員列表</a>
                <a href="ratings.php?user_id=<?= $row["id"] ?>" class="btn btn-primary mt-2">檢視用戶所有評價</a>
                <a href="order-list.php?user_id1=<?= $row["id"] ?>&user_id=" class="btn btn-primary mt-2">檢視用戶歷史訂單</a>
            </div>
        </div>
    </main>

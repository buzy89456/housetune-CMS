            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <form action="doInsert-product.php" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="mb-2">
                                        <label for="name">商品名稱</label>
                                        <input type="text" placeholder="請輸入" class="form-control" name="name" required>
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="number" placeholder="請輸入" class="form-control" name="price" required>
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input class="form-check-input ms-3" type="radio" name="posted" value="1" checked>
                                        <label class="form-check-label" for="">是</label>
                                        <input class="form-check-input ms-2" type="radio" name="posted" value="0">
                                        <label class="form-check-label" for="">否</label>
                                    </div>

                                    <div class="mb-2">
                                        <label for="" class="form-label">商品描述</label>
                                        <textarea class="form-control" name="description" rows="5" placeholder="請輸入商品描述"></textarea>
                                    </div>
                                </div>

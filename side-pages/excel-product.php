            ...
            <div class="row">
                <div class="col-md-12 mt-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="doExcel-product.php" method="post" enctype="multipart/form-data">
                                <input type="file" name="import_file" class="form-control">
                                <button type="submit" name="save_excel_data" class="btn btn-info mt-3">匯入</button>
                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form action="doExcel-product.php" method="post">
                                <select name="export_file_type" class="form-select">
                                    <option value="xlsx">XLSX</option>
                                    <option value="xls">XLS</option>
                                    <option value="csv">CSV</option>
                                </select>
                                <button type="submit" name="export_excel_btn" class="btn btn-info mt-3">匯出</button>
                            </form>
                        </div>

                    </div>
                    <a href="product-list.php" class="btn btn-secondary m-3">返回</a>
                </div>
            </div>
        </div>
    </main>
